...
if (process.env.NODE_ENV != 'test')
{
	(async () => {
		...
		//await createRepo(userId,"HW3");
		//await createIssue(userId, "HW3", "Issue for HW3", "This issue was created with CURL requests");
		await enableWikiSupport(userId,"HW3");
